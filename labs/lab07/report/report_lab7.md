...
![Создание файлов с правом выполнения](image/10.png){#fig:010 width=70%}

Лишаю владельца файла ~/may права на выполнение

![Лишение права на выполнение](image/11.png){#fig:011 width=70%}

Создаю каталог monthly с запретом на чтение для членов группы и всех
остальных пользователей

![Запрет на чтение для  некоторых групп](image/12.png){#fig:012 width=70%}

Создаю файл ~/abc1 с правом записи для членов группы:

![Право записи для членов группы](image/13.png){#fig:013 width=70%}
...
![Просмотр испольщуемых файловых систем](image/15.png){#fig:015 width=70%}

Определяю объёма свободного пространства на файловой системе - df

![Объем свободного места](image/16.png){#fig:016 width=70%}
...
![Создание директории](image/18.png){#fig:018 width=70%}
...
![Перемещаю каталоги](image/21.png){#fig:021 width=70%}

Создаю и перемещаю каталог ~/newdir в каталог ~/ski.plases и называю
его plans.

![Создание нового каталога](image/22.png){#fig:022 width=70%}
...
![Права доступа](image/23.png){#fig:023 width=70%}

Просматриваю содержимое файла /etc/password

![Название](image/24.png){#fig:024 width=70%}
...
![Перемещение файла](image/26.png){#fig:026 width=70%}

. Скопировал каталог ~/play в каталог ~/fun и переместил каталог ~/fun в каталог ~/play и назвал его games

![Копирование с изменением названия](image/27.png){#fig:027 width=70%}
...
![Попытка работы с файлом с запретом на чтение](image/29.png){#fig:029 width=70%}

Дал право на чтение

![Право на чтение](image/30.png){#fig:030 width=70%}

Забрал право на выполнение директории у владельца. Не удалость получить доступ

![Работа с директорий без право на выполнение](image/31.png){#fig:031 width=70%}

Не удалость перейти в каталог

![Работа с директорий без право на выполнение](image/32.png){#fig:032 width=70%}

Mount: показывает используемые файловые системы

![Название](image/33.png){#fig:033 width=70%}

fsck: проверяет и чинит файловую систему Linux - fsck /dev/sda1

![Название](image/34.png){#fig:034 width=70%}

mkfs: Создает файловую систему Linux - mkfs -c /dev/sda1

![Название](image/35.png){#fig:035 width=70%}

kill: Завершает процесс  - kill 495495

![Название](image/36.png){#fig:036 width=70%}
