...
![Настройка графики](image/2.png){#fig:001 width=70%}
 
Включаю общий буфер обмена и функцию переноса файлов с виртуальной машины на основную.

![Доп настройки](image/3.png){#fig:001 width=70%}
...
![Первый запуск](image/4.png){#fig:001 width=70%}

Выбираю язык интерфейса

![Выбор языка интерфейса](image/5.png){#fig:001 width=70%}
...
![Захожу в root](image/9.png){#fig:001 width=70%}
...
![Установка ПО](image/13.png){#fig:001 width=70%}

Перехожу в директорию SELinux используя mc.

![Работа в mc](image/14.png){#fig:001 width=70%}
