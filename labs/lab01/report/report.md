...
![Настройка графики](image/2.png){#fig:002 width=70%}
 
Включаю общий буфер обмена и функцию переноса файлов с виртуальной машины на основную.

![Доп настройки](image/3.png){#fig:003 width=70%}
...
![Первый запуск](image/4.png){#fig:004 width=70%}
...
![Финальные настройки перед установкой](image/6.png){#fig:006 width=70%}
...
![Отключаю установочный файл](image/8.png){#fig:008 width=70%}

Захожу в режим супер-пользователя.

![Захожу в root](image/9.png){#fig:009 width=70%}

Обновляю все пакеты командой dnf -y update.

![Обновление всех пакетов](image/10.png){#fig:010 width=70%}
...
![Подготовка ОС](image/12.png){#fig:012 width=70%}
...
![Работа в mc](image/14.png){#fig:014 width=70%}
...
![Второй запуск ВМ](image/16.png){#fig:001 width=70%}

Устанавливаю средства разработки командой dnf -y group install "Development Tools"

![Установка ПО](image/17.png){#fig:001 width=70%}

Уставаливаю DKMS командой dnf -y install dkms

![Установка ПО](image/18.png){#fig:001 width=70%}
...
![Установка ПО](image/26.png){#fig:001 width=70%}

Устанавливаю дистрибутив TeXlive.

![Установка ПО](image/.png){#fig:001 width=70%}
