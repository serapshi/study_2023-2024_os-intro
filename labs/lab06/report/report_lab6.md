...
![Перемещение по файловой системе](image/2.png){#fig:001 width=70%}
...
![Работа с директориями](image/8.png){#fig:001 width=70%}
...
![Просмотр содержимового каталога и подкаталога](image/14.png){#fig:001 width=70%}
